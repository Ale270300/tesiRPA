...
# Carico il file Excel utilizzando openpyxl per mantenerne la formattazione
file = openpyxl.load_workbook(file_path)
foglio = file["Paper in conference"]
...
nome_colonna = 'Authors'

authors_values = dati.loc[641:663, nome_colonna]

#modifica del DataFrame(le print servono per effettuare un controllo intermedio)
...
for index, value in dati.loc[641:663, 'Critical Mass or Recruited or Support Group (CM, R, SG)'].items():
    cell = foglio.cell(row=index+2, column=5)
    cell.value = value
